...
f_{X}\left(x\right) = \frac{1}{S * z(x)^{2}\Phi\left(\alpha\right)\sqrt{2\pi}}\exp\left(-\frac{1}{2}\left(\alpha - \frac{1}{z(x)}\right)^{2}\right)\\
F_{X}^{ - 1}\left(u\right)=L + S * \frac{1}{\alpha - \Phi^{ - 1}\left(u\Phi\left(\alpha\right)\right)}\\
E[X^k] = \mu'_{k} = \int_{L}^{\infty}x^{k}f_{X}\left( x \right)dx\\
\mathrm{Mean}(X) = L + S * \mu'_{1}\\
\mathrm{Variance}(X) = S^{2} * (\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
\mathrm{Median}(X) = L + S * \frac{1}{\alpha - \Phi^{ - 1}\left(\frac{1}{2}\Phi\left(\alpha\right)\right)}\\
...
F_{X}^{ - 1}\left(u\right)=a + \left( b - a \right) * \sin^{2}\left(\frac{\pi}{2}u\right)\\
E[X^k] = \mu'_{k} =\int_{a}^{b}x^{k}f_{X}\left( x \right)dx=\frac{1}{\pi}Beta\left(\frac{1}{2},k + \frac{1}{2}\right)=\frac{\left(2k - 1\right)!!}{2^{k}k!}\\
\mathrm{Mean}(X) = a + \left( b - a \right) * \mu'_{1}= a + \left( b - a \right) * \frac{1}{2}\\
\mathrm{Variance}(X) = \left( b - a \right)^{2} * (\mu'_{2} - \mu'^{2}_{1})=\frac{\left( b - a \right)^{2}}{8}\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}=0\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}=3 - \frac{3}{2}\\
\mathrm{Median}(X)=a + \left( b - a \right) * \sin^{2}\left(\frac{\pi}{4}\right)\\
\mathrm{Mode}(X)=undefined\\
...
F_{X}\left( x \right)=1 - \frac{\Psi\left(\chi\sqrt{1 - z(x)^2 / c^2}\right)}{\Psi(\chi)}\\
f_{X}\left( x \right)=\frac{1}{S}\cdot\frac{\chi^3}{\sqrt{2\pi}\,\Psi(\chi)}\cdot\frac{z(x)}{c^2}\sqrt{1 - \frac{z(x)^2}{c^2}}\exp\left(-\frac12 \chi^2\Big(1 - \frac{z(x)^2}{c^2}\Big)\right)\\
F^{ - 1}_{X}\left( u \right)=L + S\sqrt{1 - \frac{2P^{ - 1}(1.5,(1 - u)P(1.5,\frac{\chi^{2}}{2}))}{\chi^{2}}}\\
E[X^k]=\mu'_{k}=\int_{L}^{L + S}x^{k}f_{X}\left( x \right)dx\\
\mathrm{Mean}(X)=\mu'_{1}=L + S\sqrt{\pi / 8}\;\frac{\chi e^{ - \frac{\chi^2}{4}} I_1(\tfrac{\chi^2}{4})}{\Psi(\chi)}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})=S^2\!\left(1 - \frac{3}{\chi^2} + \frac{\chi\phi(\chi)}{\Psi(\chi)}\right) - (\mu - L)^2\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
\mathrm{Median}(X)=L + S\sqrt{1 - \frac{2P^{ - 1}(1.5,\frac{1}{2}P(1.5,\frac{\chi^{2}}{2}))}{\chi^{2}}}\\
...
F^{ - 1}_{X}\left( u \right)=A + (B - A) * I^{ - 1}\left( u,\alpha,\beta \right)\\
E[X^k]=\mu'_{k}=\int_{A}^{B}x^{k}f_{X}\left( x \right)dx\\
\mathrm{Mean}(X)=A + \left( B - A \right) * \mu'_{1}=A + \frac{\alpha\left( B - A \right)}{\alpha + \beta}\\
\mathrm{Variance}(X)=\left( B - A \right)^{2} * (\mu'_{2} - \mu'^{2}_{1})=\frac{\alpha\beta\left( B - A \right)^{2}}{(\alpha + \beta)^2(\alpha + \beta + 1)}\\
...
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}=3 + \frac{6[(\alpha - \beta)^2 (\alpha  + \beta + 1) - \alpha \beta (\alpha + \beta + 2)]}{\alpha \beta (\alpha + \beta + 2) (\alpha + \beta + 3)}\\
\mathrm{Median}(X)=A + (B - A) * I^{ - 1}\left( \frac{1}{2},\alpha,\beta \right)\\
\mathrm{Mode}(X)=A + (B - A) * \frac{\alpha - 1}{\alpha + \beta - 2};\alpha,\beta>1\\z\left(x \right)=\left( x - A \right) / \left( B - A \right)\\
u:\text{Uniform[0,1] random varible}\\
...
E[X^k]=\mu'_{k}=\int_{0}^{\infty}x^{k}f_{X}\left( x \right)dx=\frac{\Gamma\left(k + \alpha\right)\Gamma\left(\beta - k\right)}{\Gamma\left(\alpha\right)\Gamma\left(\beta\right)} \quad \text{if }\beta>k\\
...
\mathrm{Median}(X)=\frac{I^{ - 1}\left( 0.5,\alpha,\beta \right)}{1 - I^{ - 1}\left( 0.5,\alpha,\beta \right)}\\
...
BETA_PRIME_4P
X\sim \mathrm{BetaPrime}_{\mathrm{4P}}\left( \alpha,\beta,S,L \right)\\
x\in [L,\infty)\\
\alpha\in \mathbb{R}^{ + },\beta\in \mathbb{R}^{ + },S\in \mathbb{R}^{ + },L\in \mathbb{R}\\
...
E[X^k]=\mu'_{k}=\int_{L}^{\infty}x^{k}f_{X}\left( x \right)dx=\frac{\Gamma\left(k + \alpha\right)\Gamma\left(\beta - k\right)}{\Gamma\left(\alpha\right)\Gamma\left(\beta\right)} \quad \text{if }\beta>k\\
\mathrm{Mean}(X)=L + S\mu'_{1}=L + S\frac{\alpha}{\beta - 1} \quad \text{if }\beta>1\\
\mathrm{Variance}(X)=S^{2}(\mu'_{2} - \mu'^{2}_{1})=S^{2}\frac{\alpha(\alpha + \beta - 1)}{(\beta - 2)(\beta - 1)^2} \quad \text{if }\beta>2\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}=\frac{2(2\alpha + \beta - 1)}{\beta - 3}\sqrt{\frac{\beta - 2}{\alpha(\alpha + \beta - 1)}} \quad \text{if }\beta>3\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}} \quad \text{if }\beta>4\\
\mathrm{Median}(X)=L + S\frac{I^{ - 1}\left( 0.5,\alpha,\beta \right)}{1 - I^{ - 1}\left( 0.5,\alpha,\beta \right)}\\
...
F_{X}\left( x \right)=\frac{\ln\left(1 + c * z(x)\right)}{k}\\
f_{X}\left( x \right)=\frac{c}{k\left(1 + c * z(x)\right)\left( max - min \right)}\\
F^{ - 1}_{X}\left( u \right)=min + (max - min) * \frac{\left(1 + c\right)^{u} - 1}{c}\\
E[X^k]=\mu'_{k}=\int_{min}^{max}x^{k}f_{X}\left( x \right)dx\\
\mathrm{Mean}(X)=min + \left( max - min \right) * \mu'_{1}=min + \left( max - min \right) * \frac{c - k}{ck}\\
\mathrm{Variance}(X)=\left( max - min \right)^{2} * (\mu'_{2} - \mu'^{2}_{1})=\left( max - min \right)^{2} * \frac{\left(c + 2\right)k - 2c}{2ck^{2}}\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}=\frac{\sqrt{2}\left(12c^{2} - 9kc\left(c + 2\right) + 2k^{2}\left(c\left(c + 3\right) + 3\right)\right)}{\sqrt{c\left(c\left(k - 2\right) + 2k\right)}\left(3c\left(k - 2\right) + 6k\right)}\\
\mathrm{Kurtosis}(X)=\frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}=3 + \frac{c^{3}\left(k - 3\right)\left(k\left(3k - 16\right) + 24\right) + 12kc^{2}\left(k-4\right)\left(k - 3\right) + 6ck^{2}\left(3k - 14\right) + 12k^{3}}{3c\left(c\left(k - 2\right) + 2k\right)^{2}}\\
\mathrm{Median}(X)=min + (max - min) * \frac{\left(1 + c\right)^{0.5} - 1}{c}\\
\mathrm{Mode}(X)=min\\
k=\ln(1 + c)\\
...
E[X^k]=\mu'_{k}=\int_{0}^{\infty}x^{k}f_{X}\left( x \right)dx=A^{k}C * Beta\left( \frac{BC - k}{B},\frac{B + K}{B} \right)\\
\mathrm{Mean}(X)=\mu'_{1}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
\mathrm{Median}(X)=A\left[ (0.5)^{ - \frac{1}{c}} - 1 \right]^{\frac{1}{B}}\\
...
E[X^k]=\mu'_{k}=\int_{L}^{\infty}x^{k}f_{X}\left( x \right)dx=A^{k}C * Beta\left( \frac{BC - k}{B},\frac{B + K}{B} \right)\\
\mathrm{Mean}(X)=L + \mu'_{1}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
\mathrm{Median}(X)=L + A\left[ (0.5)^{ - \frac{1}{c}} - 1 \right]^{\frac{1}{B}}\\
...
CHI_SQUARE
X\sim \mathrm{\chi}\left( df \right)\\
x\in \left( 0, \infty \right)\\
df\in \mathbb{N}^{ + }\\
...
E[X^k]=\mu'_{k}=\int_{0}^{\infty }x^{k}f_{X}\left( x \right)dx= df(df + 2)\cdots(df + 2k - 2) = 2^k \frac{\Gamma\left(k + \frac{df}{2}\right)}{\Gamma\left(\frac{df}{2}\right)}\\
...
\mathrm{Median}(X)=2P^{ - 1}\left( \frac{df}{2},0.5 \right)\\
...
F^{ - 1}_{X}\left( u \right)=2P^{ - 1}\left( \frac{df}{2},u \right)\\
E[X^k]=\mu'_{k}=\int_{L}^{\infty }x^{k}f_{X}\left( x \right)dx=df(df + 2)\cdots(df + 2k - 2) = 2^k \frac{\Gamma\left(k + \frac{df}{2}\right)}{\Gamma\left(\frac{df}{2}\right)}\\
\mathrm{Mean}(X)=\mu'_{1}=L + S * df\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})=2df * S^{2}\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}=\sqrt{8 / df}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}=3 + \frac{12}{df}\\
\mathrm{Median}(X)=L + S * 2P^{ - 1}\left( \frac{df}{2},0.5 \right)\\
\mathrm{Mode}(X)=L + S * \max(df - 2,0)\\
L:\text{Location parameter}\\
S:\text{Scale parameter}\\
z\left(x \right)=\left( x - L \right) / S\\
u:\text{Uniform[0,1] random varible}\\
...
E[X^k]=\mu'_{k}=\int_{0}^{\infty}x^{k}f_{X}\left( x \right)dx=pb^{k}Beta\left( \frac{ap + k}{a},\frac{a - k}{a} \right)\\
\mathrm{Mean}(X)=\mu'_{1}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
...
E[X^k]=\mu'_{k}=\int_{L}^{\infty }x^{k}f_{X}\left( x \right)dx=pb^{k}Beta\left( \frac{ap + k}{a},\frac{a - k}{a} \right)\\
\mathrm{Mean}(X)=L + \mu'_{1}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
...
E[X^n]=\mu'_{n}=\int_{0}^{\infty}x^{n}f_{X}\left( x \right)dx=\beta^{k}\frac{\Gamma\left( n + k \right)}{\Gamma(k)}\\
\mathrm{Mean}(X)=\mu'_{1}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
...
E[X^n]=\mu'_{n}=\int_{L}^{\infty}x^{n}f_{X}\left( x \right)dx=\beta^{k}\frac{\Gamma\left( n + k \right)}{\Gamma(k)}\\
\mathrm{Mean}(X)=L + \mu'_{1}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
\mathrm{Median}(X)=L + P(k, \frac{1}{2\beta})\\
\mathrm{Mode}(X)=L + \beta * \left( k - 1 \right)\\
L:\text{Location parameter}\\
\beta:\text{Scale parameter}\\
u:\text{Uniform[0,1] random varible}\\
P\left(a,x \right)=\frac{\gamma(a,x)}{\Gamma(a)}:\text{Regularized lower incomplete gamma function}\\
...
E[X^k]=\mu'_{k}=\int_{0}^{\infty}x^{n}f_{X}\left( x \right)dx=\frac{k!}{\lambda^{k}}\\
...
E[X^k]=\mu'_{k}=\int_{L}^{\infty}x^{n}f_{X}\left( x \right)dx=\frac{k!}{\lambda^{k}}\\
\mathrm{Mean}(X)=L + \mu'_{1}=L + \frac{1}{\lambda}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})=\frac{1}{\lambda^2}\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}=2\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}=9\\
...
F^{ - 1}_{X}\left( u \right)=\frac{df_2 * I^{ - 1}\left( u,\frac{df_1}{2},\frac{df_2}{2} \right)}{df_1 * \left( 1 - I^{ - 1}\left( u,\frac{df_1}{2},\frac{df_2}{2} \right) \right)}\\
E[X^k]=\mu'_{k}=\int_{0}^{\infty}x^{k }f_{X}\left( x \right)dx=\left( \frac{df_2}{df_1}\right)^k \frac{\Gamma \left(\tfrac{df_1}{2} + k\right) }{\Gamma \left(\tfrac{df_1}{2}\right)} \frac{\Gamma \left(\tfrac{df_2}{2} - k\right) }{\Gamma \left( \tfrac{df_2}{2}\right) } \quad \text{if }df_2\gt 2k\\
...
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}=\frac{3\left(8 + \left(df_2 - 6\right) * \mathrm{Skewness}(X)^{2}\right)}{2df_2 - 16} + 3\quad \text{if }df_2\gt 8\\
\mathrm{Median}(X)=\frac{df_2 * I^{ - 1}\left( 0.5,\frac{df_1}{2},\frac{df_2}{2} \right)}{df_1 * \left( 1 - I^{ - 1}\left( 0.5,\frac{df_1}{2},\frac{df_2}{2} \right) \right)}\\
...
f_{X}\left( x \right)=\frac{1}{S} * \frac{\sqrt{\frac{(df_1 z(x))^{df_1} df_2^{df_2}}{(df_1 z(x) + df_2)^{df_1 + df_2}}}}{z(x)\,Beta\left(\frac{df_1}{2},\frac{df_2}{2}\right)}\\
F^{ - 1}_{X}\left( u \right)=L + S\frac{df_2 * I^{ - 1}\left( u,\frac{df_1}{2},\frac{df_2}{2} \right)}{df_1 * \left( 1 - I^{ - 1}\left( u,\frac{df_1}{2},\frac{df_2}{2} \right) \right)}\\
E[X^k]=\mu'_{k}=\int_{L}^{\infty}x^{k}f_{X}\left( x \right)dx=\frac{\Gamma \left(\tfrac{df_1}{2} + k\right) }{\Gamma \left(\tfrac{df_1}{2}\right)} \frac{\Gamma \left(\tfrac{df_2}{2} - k\right) }{\Gamma \left( \tfrac{df_2}{2}\right) }\left( \frac{df_2}{df_1}\right)^k \quad \text{if }df_2\gt 2k\\
\mathrm{Mean}(X)=L + S\mu'_{1}=L + S\frac{df_2}{df_2 - 2} \quad \text{if }df_2\gt 2\\
\mathrm{Variance}(X)=S^{2}(\mu'_{2} - \mu'^{2}_{1})=S^{2}\frac{2\,df_2^2\,(df_1 + df_2 - 2)}{df_1 (df_2 - 2)^2 (df_2-4)} \quad \text{if }df_2\gt 4\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}=\frac{(2 df_1 + df_2 - 2) \sqrt{8 (df_2-4)}}{(df_2 - 6) \sqrt{df_1 (df_1 + df_2  - 2)}}\quad \text{if }df_2\gt 6\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}=\frac{3\left(8 + \left(df_2 - 6\right) * \mathrm{Skewness}(X)^{2}\right)}{2df_2 - 16} + 3\quad \text{if }df_2\gt 8\\
\mathrm{Median}(X)=L + S\frac{df_2 * I^{ - 1}\left( 0.5,\frac{df_1}{2},\frac{df_2}{2} \right)}{df_1 * \left( 1 - I^{ - 1}\left( 0.5,\frac{df_1}{2},\frac{df_2}{2} \right) \right)}\\
...
\mathrm{Median}(X)=L + S\frac{1}{4}\left[\gamma\Phi^{ - 1}(0.5) + \sqrt{4 + \left(\gamma\Phi^{ - 1}(0.5)\right)^2}\right]^2\\
...
E[X^k]=\mu'_{k}=\int_{0}^{\infty }x^{k}f_{X}\left( x \right)dx\\
...
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
\mathrm{Median}(X)=\left| \mu + \sigma\Phi^{ - 1}(0.5) \right|\\
\mathrm{Mode}(X)=\arg\max_{x}f_{X}\left(x\right)\\
...
E[X^k]=\mu'_{k}=\int_{L}^{\infty }x^{k}f_{X}\left( x \right)dx=\Gamma\left(1 - \frac{k}{\alpha}\right)\\
...
E[X^k]=\mu'_{k}=\int_{0}^{\infty }x^{k}f_{X}\left( x \right)dx=\beta^k \frac{\Gamma(k + \alpha)}{\Gamma(\alpha)}\\
...
\mathrm{Mode}(X)=\beta P^{ - 1}\left(\alpha,0.5 \right)\\
\beta:\text{Scale parameter}\\
u:\text{Uniform[0,1] random varible}\\
P\left(a,x \right)=\frac{\gamma(a,x)}{\Gamma(a)}:\text{Regularized lower incomplete gamma function}\\
P^{ - 1}\left(a,u \right):\text{Inverse of regularized lower incomplete Gamma function}\\
...
GAMMA_3P
X\sim \mathrm{Gamma}\left( \alpha,\beta,L \right)\\
x\in \left( L,\infty \right)\\
...
E[X^k]=\mu'_{k}=\int_{L}^{\infty }x^{k}f_{X}\left( x \right)dx=\beta^k \frac{\Gamma(k + \alpha)}{\Gamma(\alpha)}\\
\mathrm{Mean}(X)=L + \mu'_{1}=L + \alpha \beta\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})=\alpha \beta^2\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}=\frac{2}{\sqrt{\alpha}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}=3 + \frac{6}{\alpha}\\
\mathrm{Median}(X)=L + (\alpha - 1)\beta \quad \text{if }\alpha>1\\
\mathrm{Mode}(X)=L + \beta P^{ - 1}\left(\alpha,0.5 \right)\\
\beta:\text{Scale parameter}\\
L:\text{Location parameter}\\
u:\text{Uniform[0,1] random varible}\\
P\left(a,x \right)=\frac{\gamma(a,x)}{\Gamma(a)}:\text{Regularized lower incomplete gamma function}\\
...
F_{X}\left( x \right)=\begin{cases} \exp\Bigl(-\exp(-z(x))\Bigr) \quad ~~ \text{if } ~~ \xi = 0 \\ \exp\Bigl(-(1 + \xi z(x))^{ - 1 / \xi}\Bigr) \quad ~~ \text{if } ~~ \xi \neq 0\end{cases}\\
f_{X}\left( x \right)=\begin{cases} \frac{1}{\sigma}\exp(-z(x)) \exp\Bigl(-\exp(-z(x))\Bigr) \quad ~~ \text{if } ~~ \xi = 0 \\ \frac{1}{\sigma}\Bigl(1 + \xi z(x)\Bigr)^{ - (1 + 1 / \xi)} \exp\Bigl(-(1 + \xi z(x))^{ - 1 / \xi}\Bigr) \quad ~~ \text{if } ~~ \xi \neq 0\end{cases}\\
F^{ - 1}_{X}\left( u \right)=\begin{cases} \mu - \sigma\ln\left(-\ln\left(u\right)\right) \quad ~ \text{if } ~ \xi = 0 \\ \mu + \displaystyle{{\,\sigma\,}\over{\,\xi\,}}\left( \left(-\ln(u)\,\right)^{ - \xi} - 1\right) \quad ~ \text{if } ~ \xi \neq 0\\ \end{cases}\\
E[X^k]=\mu'_{k}=\int_{ - \infty}^{\infty}x^{\alpha}f_{X}\left( x \right)dx=\Gamma(1 - k\xi)\\
\mathrm{Mean}(X)=\begin{cases}\mu + \sigma(\mu'_{1} - 1) / \xi \quad \text{if}\ \xi\neq 0,\xi<1,\\ \mu + \sigma\,\gamma \quad \text{if}\ \xi=0\end{cases}\\
\mathrm{Variance}(X)=\begin{cases}\sigma^2\,(\mu'_{2} - \mu'^{2}_{1}) / \xi^2 \quad \text{if}\ \xi\neq0,\xi<\frac12,\\ \sigma^2\,\frac{\pi^2}{6} \quad \text{if}\ \xi=0\end{cases}\\
\mathrm{Skewness}(X)=\begin{cases}\text{sign}(\xi)\frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}} \quad \text{if}\ \xi\neq0,\xi<\frac{1}{3},\\ \frac{12 \sqrt{6}\,\zeta(3)}{\pi^3} \quad \text{if}\ \xi=0.\end{cases}\\
\mathrm{Kurtosis}(X)=\begin{cases}\frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}} \quad \text{if}\ \xi\neq0,\xi<\frac{1}{4},\\ \frac{12}{5} \quad \text{if}\ \xi=0.\end{cases}\\
\mathrm{Median}(X)=\begin{cases}\mu + \sigma \frac{(\ln2)^{ - \xi} - 1}{\xi} \quad \text{if}\ \xi\neq0,\\ \mu - \sigma \ln\ln2 \quad \text{if}\ \xi=0.\end{cases}\\
\mathrm{Mode}(X)=\begin{cases}\mu + \sigma \frac{(1 + \xi)^{ - \xi} - 1}{\xi} \quad \text{if}\ \xi\neq0,\\ \mu \quad \text{if}\ \xi=0.\end{cases}\\
\mu:\text{Location parameter}\\
\sigma:\text{Scale parameter}\\
...
E[X^k]=\mu'_{k}=\int_{0}^{\infty}x^{\alpha}f_{X}\left( x \right)dx=a^k \frac{\Gamma (\frac{d + k}{p})}{\Gamma( \frac{d}{p})}\\
\mathrm{Mean}(X)=\mu'_{1}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
\mathrm{Median}(X)=aP^{ - 1}\left(\frac{d}{p},0.5 \right)^{\frac{1}{p}}\\
...
X\sim \mathrm{GeneralizedGamma}\left( a,d,p,L \right)\\
x\in \left( L,\infty  \right)\\
...
E[X^k]=\mu'_{k}=\int_{L}^{\infty}x^{\alpha}f_{X}\left( x \right)dx=a^k \frac{\Gamma (\frac{d + k}{p})}{\Gamma( \frac{d}{p})}\\
\mathrm{Mean}(X)=L + \mu'_{1}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
\mathrm{Median}(X)=L + aP^{ - 1}\left(\frac{d}{p},0.5 \right)^{\frac{1}{p}}\\
...
F^{ - 1}_{X}\left( u \right)=\text{sign}(p-0.5) \left[ \alpha^\beta P^{ - 1} \left(\frac{1}{\beta},2|u-0.5|\right) \right]^{1 / \beta} + \mu\\
E[X^k]=\mu'_{k}=\int_{ - \infty}^{\infty}x^{k}f_{X}\left( x \right)dx=\begin{cases}0 \quad \text{if }k\text{ is odd} \\ \alpha^{k} \Gamma \left( \frac{k + 1}{\beta} \right) \Big /  \, \Gamma \left( \frac{1}{\beta} \right) \quad \text{if }k\text{ is even}\end{cases}\\
...
E[X^k]=\mu'_{k}=\int_{ - \infty}^{\infty}x^{k}f_{X}\left( x \right)dx=\frac{\left(-1\right)^{k}}{c^{k}}\sum_{i=0}^{k}\binom{k}{i}\frac{\left(-1\right)^{i}}{1 - ci}\quad \text{if }<\frac{1}{k}\\
...
F^{ - 1}_{X}\left( u \right)=L + S * \exp\left( \Phi^{ - 1}\left(u\right)\right)\\
E[X^k]=\mu'_{k}=\int_{L}^{\infty}x^{k}f_{X}\left( x \right)dx=\exp\left( \frac{k^{2}}{2} \right)\\
...
\mathrm{Median}(X)=L + S * \exp\left( \Phi^{ - 1}\left(0.5\right)\right)\\
...
\mathrm{Mean}(X)=\mu + \sigma\mu'_{1}=\mu - \gamma\sigma\\
\mathrm{Variance}(X)=\sigma^{2}(\mu'_{2} - \mu'^{2}_{1})=\sigma^{2}\frac{\pi^{2}}{6}\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}= - \frac{12\sqrt{6}\zeta(3)}{\pi^{3}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}=3 + \frac{12}{5}\\
\mathrm{Median}(X)=\mu + \sigma\ln\left(-\ln\left(0.5\right)\right)\\
\mathrm{Mode}(X)=\mu\\
\mu:\text{Location parameter}\\
\sigma:\text{Scale parameter}\\
z\left(x \right)=\left( x - \mu \right) / \sigma\\
...
F^{ - 1}_{X}\left( u \right)=\mu + \sigma\Phi^{ - 1}\left( \frac{1 + u}{2} \right)=\mu + \sigma\sqrt{2}\operatorname{erf}^{ - 1}(u)\\
E[X^k]=\mu'_{k}=\int_{\mu}^{\infty}x^{k}f_{X}\left( x \right)dx=\frac{2^{n / 2} \Gamma(\frac{n + 1}{2})}{\sqrt{\pi}}\\
\mathrm{Mean}(X)=\mu + \sigma\mu'_{1}=\mu + \sigma\sqrt{\frac{2}{\pi}}\\
\mathrm{Variance}(X)=\sigma^{2}(\mu'_{2} - \mu'^{2}_{1})=\sigma^2\left(1 - \frac 2 \pi \right)\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}=\frac{\sqrt{2}(4 - \pi)}{(\pi - 2)^{3 / 2}}=0.9952717\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}=3 + \frac{8(\pi - 3)}{(\pi - 2)^2}= 3.869177\\
...
E[X^k]=\mu'_{k}=\int_{ - \infty}^{\infty}x^{k}f_{X}\left( x \right)dx=\frac{1 + \left(-1\right)^{k}}{2\pi2^{2k}}k!\left[\zeta\left(k + 1,\frac{1}{4}\right) - \zeta\left(k + 1,\frac{3}{4}\right)\right]\\
\mathrm{Mean}(X)=\mu + \sigma\mu'_{1}=\mu\\
\mathrm{Variance}(X)=\sigma^{2}(\mu'_{2} - \mu'^{2}_{1})=\sigma^{2}\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}=0\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}=3\\
\mathrm{Median}(X)=\mu\\
\mathrm{Mode}(X)=\mu\\
...
E[X^k]=\mu'_{k}=\int_{0}^{\infty}x^{k}f_{X}\left( x \right)dx=\frac{\Gamma(\alpha - k)}{\Gamma(\alpha)} = \frac{1}{(\alpha - 1) \cdots (\alpha - k)}\quad \text{if } \alpha>k\\
\mathrm{Mean}(X)=\beta\mu'_{1} \\
\mathrm{Variance}(X)=\beta^{2}(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
\mathrm{Median}(X)=\frac{\beta}{P^{ - 1}\left(\alpha,0.5 \right)}\\
...
INVERSE_GAMMA_3P
X\sim \mathrm{InverseGamma}_{3P}\left( \alpha,\beta,L \right)\\
x\in \left( L,\infty  \right)\\
\alpha\in \mathbb{R}^{ + },\beta\in \mathbb{R}^{ + },L\in \mathbb{R}\\
...
E[X^k]=\mu'_{k}=\int_{L}^{\infty}x^{k}f_{X}\left( x \right)dx=\frac{\Gamma(\alpha - k)}{\Gamma(\alpha)} = \frac{1}{(\alpha - 1) \cdots (\alpha - k)}\quad \text{if } \alpha>k\\
\mathrm{Mean}(X)=L + \beta\mu'_{1} \\
\mathrm{Variance}(X)=\beta^{2}(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
\mathrm{Median}(X)=L + \frac{\beta}{P^{ - 1}\left(\alpha,0.5 \right)}\\
...
Sample_{X}=\left\{ \begin{array}{cl} x_{0} \quad \text{if} \quad u_{2}\leqslant \frac{\mu}{\mu + x_{0}}\\ \frac{\mu^{2}}{x_{0}} \quad \text{if} \quad u_{2}\geqslant  \frac{\mu}{\mu + x_{0}} \end{array} \right.\\
E[X^k]=\mu'_{k}=\int_{0}^{\infty }x^{k}f_{X}\left( x \right)dx\\
...
INVERSE_GAUSSIAN_3P
X\sim \mathrm{InverseGaussian}_{3P}\left( \mu,\lambda,L \right)\\
x\in \left( 0,\infty  \right)\\
...
E[X^k]=\mu'_{k}=\int_{\xi}^{\xi + \lambda }x^{k}f_{X}\left( x \right)dx\\
\mathrm{Mean}(X)=\mu'_{1}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
\mathrm{Median}(X)=\frac{\lambda\exp\left(\frac{\Phi^{ - 1}(0.5) - \gamma}{\delta}\right)}{1 + \exp\left(\frac{\Phi^{ - 1}(0.5) - \gamma}{\delta}\right)} + \xi\\
\mathrm{Mode}(X)=\arg\max_{x}f_{X}\left(x\right)\\
...
F^{ - 1}_{X}\left( u \right)=min + \left( max - min \right) * (1 - (1 - u)^\frac{1}{\beta})^\frac{1}{\alpha}\\
E[X^k]=\mu'_{k}=\int_{min}^{max}x^{k}f_{X}\left( x \right)dx=\beta Beta(1 + \frac{k}{\alpha},\beta)\\
\mathrm{Mean}(X)=min + \left( max - min \right) * \mu'_{1}\\
\mathrm{Variance}(X)=\left( max - min \right)^{2}(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
...
F^{ - 1}_{X}\left( u \right)=\mu - b\,\mathrm{sign}(p-0.5)\,\ln(1 - 2|p-0.5|)\\
E[X^k]=\mu'_{k}=\int_{ - \infty}^{\infty}x^{k}f_{X}\left( x \right)dx=\bigg({\frac{1}{2}}\bigg) \sum_{k=0}^r \bigg[{\frac{r!}{(r - k)!}} b^k \mu^{(r - k)} \{1 + (-1)^k\}\bigg]\\
\mathrm{Mean}(X)=\mu'_{1}=\mu\\
...
F^{ - 1}_{X}\left( u \right)=\mu + \frac{\sigma}{2\left(\textrm{erf}^{ - 1}(1 - u)\right)^2}\\
E[X^k]=\mu'_{k}=\int_{\mu }^{\infty }x^{k}f_{X}\left( x \right)dx\\
...
\mathrm{Median}(X)=\mu + c / 2(\textrm{erfc}^{ - 1}(1 / 2))^2\\
...
\mathrm{Median}(X)=\mu + \sigma\ln\left(P^{ - 1}\left(0.5,c\right)\right)\\
...
E[X^k]=\mu'_{k}=\int_{0}^{\infty}x^{k}f_{X}\left( x \right)dx=\alpha^k Beta(1 - k / \beta, 1 + k / \beta)=\alpha^k\, {k\pi / \beta \over \sin(k\pi / \beta)}\\
\mathrm{Mean}(X)=\mu'_{1}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
...
LOGLOGISTIC_3P
X\sim \mathrm{LogLogistic}\left( \alpha,\beta,L \right)\\
x\in [L,\infty)\\
\alpha\in \mathbb{R}^{ + },\beta\in \mathbb{R}^{ + },L\in \mathbb{R}\\
...
E[X^k]=\mu'_{k}=\int_{L}^{\infty}x^{k}f_{X}\left( x \right)dx=\alpha^k Beta(1 - k / \beta, 1 + k / \beta)=\alpha^k\, {k\pi / \beta \over \sin(k\pi / \beta)}\\
\mathrm{Mean}(X)=L + \mu'_{1}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
...
E[X^k]=\mu'_{k}=\int_{ - \infty}^{\infty}x^{k}f_{X}\left( x \right)dx=e^{k\mu + k^2\sigma^2 / 2}\\
\mathrm{Mean}(X)=\mu'_{1}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
...
\mathrm{Median}(X)=L + \alpha\sqrt{2P^{ - 1}\left(1.5,0.5 \right)}\\
...
\mathrm{Median}(X)=\mu + \sigma\ln\left[ 2P^{ - 1}\left(\frac{1}{2},0.5 \right) \right]\\
\mathrm{Mode}(X)=\mu\\
\mu:\text{Location parameter}\\
\sigma:\text{Scale parameter}\\
z\left(x \right)=\left( x - \mu \right) / \sigma\\
...
x\in \left( 0,\infty  \right)\\
m\in \mathbb{R}^{ + }_{\geqslant 0.5},\Omega\in \mathbb{R}^{ + }\\
...
\mathrm{Median}(X)=\sqrt{\frac{\Omega}{m}P^{ - 1}\left(m,0.5 \right)}\\
...
X\sim \mathrm{NoncentralChiSquare}\left( n,\lambda \right)\\
x\in [0,  + \infty)\\
n\in \mathbb{R}^{ + },\lambda\in \mathbb{R}^{ + }\\
...
E[X^k]=\mu'_{k}=\int_{0}^{\infty}x^{k}f_{X}\left( x \right)dx=2^{k - 1}(k - 1)!(n + k\lambda) + \sum_{j=1}^{k - 1} \frac{(k - 1)!2^{j - 1}}{(k - j)!}(n + j\lambda )\mu'_{k - j}\\
...
f_{X}\left( x \right)=\sum\limits_{k=0}^\infty\frac{e^{ - \lambda / 2}(\lambda / 2)^k}{ Beta\left(\frac{n_2}{2},\frac{n_1}{2} + k\right) k!}
\left(\frac{n_1}{n_2}\right)^{\frac{n_1}{2} + k}\left(\frac{n_2}{n_2 + n_1x}\right)^{\frac{n_1 + n_2}{2} + k}x^{n_1 / 2 - 1 + k}\\
...
E[X^k]=\mu'_{k}=\int_{0}^{\infty}x^{k}f_{X}\left( x \right)dx=e^{ - \lambda / 2}\left( \frac{n1}{n2} \right)^{k}\frac{\Gamma\left( 
n_1 / 2 - k \right)}{\Gamma\left( n_1 / 2 \right)}\sum_{r=0}^{\infty }\left( \frac{1}{r!} \right)\left( \frac{\lambda}{2} \right)^{r}\frac{\Gamma\left( \frac{m}{2} + r + k \right)}{\Gamma\left( \frac{m}{2} + r \right)}\\
\mathrm{Mean}(X)=\mu'_{1}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
...
F_{X}\left( x \right)=\begin{cases} \frac{1}{2}\sum_{j=0}^\infty\frac{1}{j!}(-\lambda\sqrt{2})^je^{\frac{ - \lambda^2}{2}}\frac{\Gamma(\frac{j + 1}{2})}{\sqrt{\pi}}I_{n / (n + z(x)^2)}\left (\frac{n}{2},\frac{j + 1}{2}\right ) & z(x)\ge 0 \\ 1 - \frac{1}{2}\sum_{j=0}^\infty\frac{1}{j!}(-\lambda\sqrt{2})^je^{\frac{ - \lambda^2}{2}}\frac{\Gamma(\frac{j + 1}{2})}{\sqrt{\pi}}I_{n / (n + z(x)^2)}\left (\frac{n}{2},\frac{j + 1}{2}\right ) & z(x) < 0\end{cases}\\
...
E[X^k]=\mu'_{k}=\int_{ - \infty}^{\infty}x^{k}f_{X}\left( x \right)dx=\frac{e^{ - \lambda^{2} / 2}}{\sqrt{n\pi}\Gamma\left( n / 2 \right)}\Gamma\left( \frac{n - k}{2} \right)n^{k / 2}\sum_{r=0}^{\infty }\frac{\lambda^{r}2^{r / 2}}{r!}\Gamma\left( \frac{r + k + 1}{2} \right)\\
\mathrm{Mean}(X)=L + S\mu'_{1}\\
\mathrm{Variance}(X)=S^{2}(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
...
E[X^k]=\mu'_{k}=\int_{ - \infty}^{\infty}x^{k}f_{X}\left( x \right)dx=\sigma^k\cdot (-i\sqrt 2)^k U\left(-\frac{k}{2}, \frac{1}{2},  - \frac{1}{2} \left( \frac \mu \sigma \right)^2 \right)\\
\mathrm{Mean}(X)=\mu'_{1}=\mu\\
...
PARETO_FIRST_KIND
X\sim \mathrm{ParetoFirstKind}\left( \alpha,x_\mathrm{m},L \right)\\
x\in [L + x_\mathrm{m}, \infty)\\
\alpha\in \mathbb{R}^{ + },x_\mathrm{m}\in \mathbb{R}^{ + },L\in \mathbb{R}\\
...
E[X^k]=\mu'_{k}=\int_{L + x_\mathrm{m}}^{\infty}x^{k}f_{X}\left( x \right)dx=\begin{cases} \infty & \alpha\le k \\ \frac{\alpha x_\mathrm{m}^k}{\alpha - k} & \alpha>k \end{cases}\\
\mathrm{Mean}(X)=L + \mu'_{1}=\dfrac{\alpha x_\mathrm{m}}{\alpha - 1} \quad \text{if }\alpha>1\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})=\dfrac{x_\mathrm{m}^2\alpha}{(\alpha -  1)^2(\alpha - 2)} \quad \text{if }\alpha>2\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}=\frac{2(1 + \alpha)}{\alpha - 3}\sqrt{\frac{\alpha - 2}{\alpha}}\quad \text{if } \alpha>3\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}=\frac{6(\alpha^3 + \alpha^2 - 6\alpha - 2)}{\alpha(\alpha - 3)(\alpha-4)}\quad \text{if }\alpha>4\\
...
PARETO_SECOND_KIND
X\sim \mathrm{ParetoSecondKind}\left( \alpha,x_\mathrm{m},L \right)\\
x\in \left( L,\infty  \right)\\
\alpha\in \mathbb{R}^{ + },x_\mathrm{m}\in \mathbb{R}^{ + },L\in \mathbb{R}\\
...
E[X^k]=\mu'_{k}=\int_{L}^{\infty}x^{k}f_{X}\left( x \right)dx=\frac{x_\mathrm{m}^k \Gamma(\alpha - k)\Gamma(1 + k)}{\Gamma(\alpha)}\\
\mathrm{Mean}(X)=\mu'_{1}={x_\mathrm{m} \over {\alpha  - 1}}  \quad \text{if }\alpha>1\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})={{x_\mathrm{m}^2 \alpha} \over {(\alpha - 1)^2(\alpha - 2)}} \quad \text{if }\alpha>2\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}=\frac{2(1 + \alpha)}{\alpha - 3}\,\sqrt{\frac{\alpha - 2}{\alpha}} \quad \text{if }\alpha>3\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}=\frac{6(\alpha^3 + \alpha^2 - 6\alpha - 2)}{\alpha(\alpha - 3)(\alpha-4)} \quad \text{if }\alpha>4\\
...
E[X^k]=\mu'_{k}=\int_{a}^{c}x^{k}f_{X}\left( x \right)dx\\
...
\mathrm{Median}(X)=a + (c - a)\cdot I^{ - 1}\left( 0.5,\alpha_{1},\alpha_{2} \right)\\
\mathrm{Mode}(X)=b\\
...
\mathrm{Median}(X)=\left[ a + 0.5(b - a) \right]^{ - \alpha}\\
\mathrm{Mode}(X)=undefined\\
...
f_{X}\left( x \right)=z(x) * e^{ - z(x)^{2} / 2} / S\\
F^{ - 1}_{X}\left( u \right)=L + S\sqrt{ - 2\log\left(1 - u\right)}\\
E[X^k]=\mu'_{k}=\int_{L }^{\infty }x^{k}f_{X}\left( x \right)dx=\sqrt{2^{n}}\Gamma\left(\frac{n}{2} + 1\right)\\
\mathrm{Mean}(X)=L + \mu'_{1}=L + S\sqrt{\frac{\pi}{2}}\\
...
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}=\frac{24\pi - 6\pi^{2} - 16}{\left(4 - \pi\right)^{2}} + 3\\
\mathrm{Median}(X)=L + S\sqrt{ - 2\log\left(0.5\right)}\\
\mathrm{Mode}(X)=L + S\\
L:\text{Location parameter}\\
S:\text{Scale parameter}\\
z\left(x \right)=\left( x - L \right) / S\\
...
E[X^k]=\mu'_{k}=\int_{a }^{b}x^{k}f_{X}\left( x \right)dx=\frac{b^k - a^k}{k\left( \ln(b) - \ln(a) \right)}\\
\mathrm{Mean}(X)=\mu'_{1}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
\mathrm{Median}(X)=\exp(\ln(a) + 0.5 * \left( \ln(b) - \ln(a) \right))\\
\mathrm{Mode}(X)=a\\
u:\text{Uniform[0,1] random varible}\\
...
E[X^k]=\mu'_{k}=\int_{ - \infty }^{\infty }x^{k}f_{X}\left( x \right)dx=\sigma^k2^{k / 2}\,\Gamma(1 + k / 2)\,L_{k / 2}(-v^2 / 2\sigma^2)\\
\mathrm{Mean}(X)=\mu'_{1}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
\mathrm{Median}(X)=\text{complicated}\\
\mathrm{Mode}(X)=\text{complicated}\\
\text{It is not possible to compute an analytic function for the inverse of the cumulative}\\
\text{density function. However, we can compute a random sample from the distribution.}\\
...
F^{ - 1}_{X}\left( u \right)=L + R * (2I^{ - 1}\left( u,1.5,1.5 \right) - 1)\\
E[X^k]=\mu'_{k}=\int_{L}^{\infty }x^{k}f_{X}\left( x \right)dx\\
\mathrm{Mean}(X)=L + \mu'_{1}=L\\
...
x\in \left(  - \infty ,\infty  \right)\\ df\in \mathbb{R}^{ + }\\ 
F_{X}\left( x \right)=I\left( \frac{x + \sqrt{x^{2} + df}}{2\sqrt{x^{2} + df}},\frac{df}{2},\frac{df}{2} \right)\\ 
f_{X}\left( x \right)=\frac{\left( 1 + x^{2} / df \right)^{ - (1 + df) / 2}}{\sqrt{df} * Beta\left( 0.5,\frac{df}{2} \right)}\\ 
F^{ - 1}_{X}\left( u \right)=\left\{ \begin{array}{cl} \sqrt{\frac{df(1 - I^{ - 1}\left( u,df / 2,df / 2 \right))}{I^{ - 1}\left( u,df / 2,df / 2 \right)}} & \text{if } \ u \geq 0.5 \\  - \sqrt{\frac{df(1 - I^{ - 1}\left( u,df / 2,df / 2 \right))}{I^{ - 1}\left( u,df / 2,df / 2 \right)}} & \text{if } \ u < 0.5 \end{array} \right.\\ 
E[X^k]=\mu'_{k}=\int_{ - \infty }^{\infty }x^{k}f_{X}\left( x \right)dx=\left\{ \begin{array}{cl} 0 & \text{if } \ k\text{ odd} \ \wedge \ 0 < k < df \\ df^{\frac{k}{2}} \, \prod_{i=1}^{k / 2} \frac{2i - 1}{df - 2i} & \text{if } \ k\text{ even} \ \wedge \ 0 < k < df \end{array} \right.\\ 
\mathrm{Mean}(X)=\mu'_{1}=0\\ 
...
x\in \left(  - \infty ,\infty  \right)\\ df\in \mathbb{R}^{ + },L\in \mathbb{R},S\in \mathbb{R}^{ + }\\ 
F_{X}\left( x \right)=I\left( \frac{z(x) + \sqrt{z(x)^{2} + df}}{2\sqrt{z(x)^{2} + df}},\frac{df}{2},\frac{df}{2} \right)\\ 
f_{X}\left( x \right)=\frac{\left( 1 + z(x)^{2} / df \right)^{ - (1 + df) / 2}}{\sqrt{df} * Beta\left( 0.5,\frac{df}{2} \right)}\\ 
F^{ - 1}_{X}\left( u \right)=\left\{ \begin{array}{cl} L + S \ \sqrt{\frac{df(1 - I^{ - 1}\left( u,df / 2,df / 2 \right))}{I^{ - 1}\left( u,df / 2,df / 2 \right)}} & \text{if } \ u \geq 0.5 \\ L - S \ \sqrt{\frac{df(1 - I^{ - 1}\left( u,df / 2,df / 2 \right))}{I^{ - 1}\left( u,df / 2,df / 2 \right)}} & \text{if } \ u < 0.5 \end{array} \right.\\ 
E[X^k]=\mu'_{k}=\int_{ - \infty }^{\infty }x^{k}f_{X}\left( x \right)dx=\left\{ \begin{array}{cl} 0 & \text{if } \ k\text{ odd} \ \wedge \ 0 < k < df \\ df^{\frac{k}{2}} \, \prod_{i=1}^{k / 2} \frac{2i - 1}{df - 2i} & \text{if } \ k\text{ even} \ \wedge \ 0 < k < df \end{array} \right.\\ 
\mathrm{Mean}(X)=L + \mu'_{1}=L\\ 
\mathrm{Variance}(X)=S^{2} * (\mu'_{2} - \mu'^{2}_{1})=\left\{ \begin{array}{cl} S^{2} \ df / (df + 2) & \text{if } \ df > 2 \\ \text{undefined} & \text{if } \  df \leq 2 \end{array} \right.\\ 
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}=\left\{ \begin{array}{cl} 0 & \text{if } \ df > 3 \\ \text{undefined} & \text{if } \  df \leq 3 \end{array} \right.\\ 
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}=\left\{ \begin{array}{cl} 6 / (df-4) & \text{if } \ df > 4 \\ \text{undefined} & \text{if } \ df \leq 4 \end{array} \right.\\ 
\mathrm{Median}(X)=L\\ 
\mathrm{Mode}(X)=L\\
...
F^{ - 1}_{X}\left( u \right)=\left\{ \begin{array}{cl} a + \sqrt{u * (d + c - a - b) * (b - a)} & \text{if } u \leq A_{1} \\ (a + b + u * (d + c - a - b)) / 2 & \text{if } A_{1} \leq u \leq A_{1} + A_{2} \\ d - \sqrt{(1 - u) * (d + c - a - b) * (d - c)} & \text{if } A_{1} + A_{2} \leq u \leq A_{1} + A_{2} + A_{3}  \end{array} \right.\\
E[X^k]=\mu'_{k}=\int_{a}^{b}x^{k}f_{X}\left( x \right)dx=\frac{2}{d + c - b - a}\frac{1}{(k + 1)(k + 2)}\left(\frac{d^{k + 2} - c^{k + 2}}{d - c} - \frac{b^{k + 2} - a^{k + 2}}{b - a}\right)\\
\mathrm{Mean}(X)=\mu'_{1}\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
...
E[X^k]=\mu'_{k}=\int_{ - \infty }^{\infty }x^{k}f_{X}\left( x \right)dx=\frac{1}{k + 1}\sum_{i=0}^k a^ib^{k - i}\\
...
E[X^k]=\mu'_{k}=\int_{0}^{\infty }x^{k}f_{X}\left( x \right)dx=\beta^\alpha \Gamma\left(1 + \frac{k}{\alpha}\right)\\
\mathrm{Mean}(X)=\mu'_{1}=\beta \ \Gamma(1 + 1 / \alpha)\\
...
E[X^k]=\mu'_{k}=\int_{L}^{\infty }x^{k}f_{X}\left( x \right)dx=\beta^\alpha \Gamma\left(1 + \frac{k}{\alpha}\right)\\
\mathrm{Mean}(X)=L + \mu'_{1}=L + \beta \ \Gamma(1 + 1 / \alpha)\\
\mathrm{Variance}(X)=(\mu'_{2} - \mu'^{2}_{1})=\beta^2\left[\Gamma\left(1 + 2 / \alpha\right) - \left(\Gamma\left(1 + 1 / \alpha\right)\right)^2\right]\\
\mathrm{Skewness}(X) = \frac{\mu'_{3} - 3\mu'_{2}\mu'_{1} + 2\mu'^{3}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{1.5}}\\
\mathrm{Kurtosis}(X) = \frac{\mu'_{4}-4\mu'_{1}\mu'_{3} + 6\mu'^{2}_{1}\mu'_{2} - 3\mu'^{4}_{1}}{(\mu'_{2} - \mu'^{2}_{1})^{2}}\\
