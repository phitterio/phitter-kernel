...
if __name__ == "__main__":
    ...
    _all_distributions: list = [BERNOULLI, BINOMIAL, GEOMETRIC, HYPERGEOMETRIC, LOGARITHMIC, NEGATIVE_BINOMIAL, POISSON, UNIFORM]
    ...
    for distribution_class in _all_distributions:
        ...
        print(test_chi_square_discrete(distribution, measurements))