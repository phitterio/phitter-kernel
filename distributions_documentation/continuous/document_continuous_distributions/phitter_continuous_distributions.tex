...
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/alpha.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/arcsine.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/argus.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/beta.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/beta_prime.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/beta_prime_4p.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/bradford.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/burr.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/burr_4p.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/cauchy.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/chi_square.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/chi_square_3p.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/dagum.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/dagum_4p.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/erlang.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/erlang_3p.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/error_function.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/exponential.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/exponential_2p.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/f.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/f_4p.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/fatigue_life.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/folded_normal.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/frechet.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/gamma.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/gamma_3p.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/generalized_extreme_value.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/generalized_gamma.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/generalized_gamma_4p.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/generalized_logistic.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/generalized_normal.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/generalized_pareto.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/gibrat.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/gumbel_left.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/gumbel_right.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/half_normal.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/hyperbolic_secant.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/inverse_gamma.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/inverse_gamma_3p.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/inverse_gaussian.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/inverse_gaussian_3p.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/johnson_sb.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/johnson_su.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/kumaraswamy.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/laplace.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/levy.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/loggamma.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/logistic.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/loglogistic.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/loglogistic_3p.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/lognormal.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/maxwell.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/moyal.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/nakagami.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/non_central_chi_square.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/non_central_f.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/non_central_t_student.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/normal.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/pareto_first_kind.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/pareto_second_kind.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/pert.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/power_function.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/rayleigh.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/reciprocal.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/rice.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/semicircular.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/t_student.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/t_student_3p.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/trapezoidal.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/triangular.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/uniform.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/weibull.xlsx}{\color{teal}{Excel file from GitHub repository}}
...
\subsection{Spreadsheet documents}
\begin{itemize}
    \item \href{https://github.com/phitter-core/phitter-files/blob/main/continuous/weibull_3p.xlsx}{\color{teal}{Excel file from GitHub repository}}
