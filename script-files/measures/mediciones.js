const MEASUREMENTS = {
        ...
        measurements: {
            ...
            stats: {
                mean: function (df1, df2, loc, scale) {
                    const miu1 = dists.f_4p.measurements.nonCentralMoments(1, df1, df2, loc, scale);
                    return loc + scale * miu1;
                },
                variance: function (df1, df2, loc, scale) {
                    const miu1 = dists.f_4p.measurements.nonCentralMoments(1, df1, df2, loc, scale);
                    const miu2 = dists.f_4p.measurements.nonCentralMoments(2, df1, df2, loc, scale);
                    return scale ** 2 * (miu2 - miu1 ** 2);
                },
                ...
                skewness: function (df1, df2, loc, scale) {
                    const central_miu3 = dists.f_4p.measurements.centralMoments(3, df1, df2, loc, scale);
                    return central_miu3 / this.standardDeviation(df1, df2, loc, scale) ** 3;
                },
                kurtosis: function (df1, df2, loc, scale) {
                    const central_miu4 = dists.f_4p.measurements.centralMoments(4, df1, df2, loc, scale);
    ...
    loglogistic_3p: {
        measurements: {
            ...
            stats: {
                mean: function (alpha, beta, loc) {
                    const miu1 = dists.loglogistic_3p.measurements.nonCentralMoments(1, alpha, beta, loc);
                    return loc + miu1;
                },
                variance: function (alpha, beta, loc) {
                    const miu1 = dists.loglogistic_3p.measurements.nonCentralMoments(1, alpha, beta, loc);
                    const miu2 = dists.loglogistic_3p.measurements.nonCentralMoments(2, alpha, beta, loc);
                    return miu2 - miu1 ** 2;
                },
                standardDeviation: function (alpha, beta, loc) {
                    return Math.sqrt(this.variance(alpha, beta, loc));
                ...
                skewness: function (alpha, beta, loc) {
                    const central_miu3 = dists.loglogistic_3p.measurements.centralMoments(3, alpha, beta, loc);
                    return central_miu3 / this.standardDeviation(alpha, beta, loc) ** 3;
                },
                kurtosis: function (alpha, beta, loc) {
                    const central_miu4 = dists.loglogistic_3p.measurements.centralMoments(4, alpha, beta, loc);
                    return central_miu4 / this.standardDeviation(alpha, beta, loc) ** 4;
                },
                median: function (alpha, beta, loc) {
