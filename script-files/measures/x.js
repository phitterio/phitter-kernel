...
//         const miu1 = this.nonCentralMoments(1, p);
//         const miu2 = this.nonCentralMoments(2, p);
//         const miu3 = this.nonCentralMoments(3, p);
//         const miu4 = this.nonCentralMoments(4, p);
...
//     stats: {
//         mean: function (p) {
//             const miu1 = dists.gamma.measurements.nonCentralMoments(1, p);
//             return miu1;
//         },
//         variance: function (p) {
//             const miu1 = dists.gamma.measurements.nonCentralMoments(1, p);
//             const miu2 = dists.gamma.measurements.nonCentralMoments(2, p);
//             return miu2 - miu1 ** 2;
//         },
...
//         },
//         skewness: function (p) {
//             const central_miu3 = dists.gamma.measurements.centralMoments(3, p);
//             console.log(central_miu3)
//             return central_miu3 / (this.standardDeviation(p) ** 3);
//         },
//         kurtosis: function (p) {
//             const central_miu4 = dists.gamma.measurements.centralMoments(4, p);
//             return central_miu4 / (this.standardDeviation(p) ** 4);
//         },
//         median: function (p) {
